...
class MemberRepository implements RepositoryInterface
{
    ...
    {
        return $this->member->newQuery()->where('team_id', Auth::user()->team_id)->get($columns);
    }
    ...
    {
        return $this->member->newQuery()->where('team_id', Auth::user()->team_id)->with($relations)->get($columns);
    }
    ...
    {
        return $this->member->newQuery()->findOrFail($id, $columns);
    }
    ...
    {
        return $this->member->newQuery()->with($relations)->findOrFail($id, $columns);
    }
